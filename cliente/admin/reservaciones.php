    ...
    <div id="app">
            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="mainTitle">Administrador | Citas</h1>
                            </div>
                            <ol class="breadcrumb">
                                <li>
                                    <span>Admin</span>
        ...
        <form method="POST" action="">
            <div class="form-group">
                <label for="opcion">Filtrar:</label>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST" && !isset($_POST['delete_id'])) {
            ...
            switch ($opcion) {
                case "todo":
                    $sql = "SELECT C.id_cita, C.cliente, C.tel, C.email, S.servicio, E.nombre AS empleado, C.fecha, C.hora 
                            FROM Cita C 
